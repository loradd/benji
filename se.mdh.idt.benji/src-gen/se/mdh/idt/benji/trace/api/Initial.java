...
public final class Initial extends BaseGeneratedEMFQuerySpecification<Initial.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Initial.Match newMutableMatch(final TraceLink pTraceLink, final EObject pSource) {
     ...
     * 
     */
    public static Initial.Match newMatch(final TraceLink pTraceLink, final EObject pSource) {
  ...
  public static class Matcher extends BaseMatcher<Initial.Match> {
     ...
     * 
     */
    public Collection<Initial.Match> getAllMatches(final TraceLink pTraceLink, final EObject pSource) {
     ...
     * 
     */
    public Initial.Match getOneArbitraryMatch(final TraceLink pTraceLink, final EObject pSource) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pTraceLink, final EObject pSource, final IMatchProcessor<? super Initial.Match> processor) {
     ...
     * 
     */
    public Initial.Match newMatch(final TraceLink pTraceLink, final EObject pSource) {
      return Initial.Match.newMatch(pTraceLink, pSource);
    }
     ...
     * 
     */
    public Set<EObject> getAllValuesOfsource(final Initial.Match partialMatch) {
    ...
    protected Initial.Match tupleToMatch(final Tuple t) {
      try {
          return Initial.Match.newMatch((TraceLink) t.get(POSITION_TRACELINK), (EObject) t.get(POSITION_SOURCE));
    ...
    protected Initial.Match arrayToMatch(final Object[] match) {
      try {
          return Initial.Match.newMatch((TraceLink) match[POSITION_TRACELINK], (EObject) match[POSITION_SOURCE]);
      } catch(ClassCastException e) {
    ...
    protected Initial.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Initial.Match.newMutableMatch((TraceLink) match[POSITION_TRACELINK], (EObject) match[POSITION_SOURCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
