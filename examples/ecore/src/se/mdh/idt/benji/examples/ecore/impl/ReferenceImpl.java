 ...
 * </p>
 * <ul>
 *   <li>{@link se.mdh.idt.benji.examples.ecore.impl.ReferenceImpl#getType <em>Type</em>}</li>
 *   <li>{@link se.mdh.idt.benji.examples.ecore.impl.ReferenceImpl#getOpposite <em>Opposite</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferenceImpl extends NamedElementImpl implements Reference {
	 ...
	 * @ordered
	 */
	protected se.mdh.idt.benji.examples.ecore.Class type;
	 ...
	 */
	@Override
	public se.mdh.idt.benji.examples.ecore.Class getType() {
		if (type != null && type.eIsProxy()) {
			InternalEObject oldType = (InternalEObject)type;
			type = (se.mdh.idt.benji.examples.ecore.Class)eResolveProxy(oldType);
			if (type != oldType) {
	 ...
	 * @generated
	 */
	public se.mdh.idt.benji.examples.ecore.Class basicGetType() {
		return type;
	}
	 ...
	 */
	@Override
	public void setType(se.mdh.idt.benji.examples.ecore.Class newType) {
		se.mdh.idt.benji.examples.ecore.Class oldType = type;
		type = newType;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case EcorePackage.REFERENCE__TYPE:
				setType((se.mdh.idt.benji.examples.ecore.Class)newValue);
				return;
			case EcorePackage.REFERENCE__OPPOSITE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case EcorePackage.REFERENCE__TYPE:
				setType((se.mdh.idt.benji.examples.ecore.Class)null);
				return;
			case EcorePackage.REFERENCE__OPPOSITE:
