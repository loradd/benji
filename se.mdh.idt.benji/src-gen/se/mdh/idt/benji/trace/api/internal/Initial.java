...
public final class Initial extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  private Initial() {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.trace.api.internal.Initial (visibility: PUBLIC, simpleName: Initial, identifier: se.mdh.idt.benji.trace.api.internal.Initial, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace.api.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.trace.api.internal.Initial (visibility: PUBLIC, simpleName: Initial, identifier: se.mdh.idt.benji.trace.api.internal.Initial, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace.api.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
