...
import se.mdh.idt.benji.examples.ecore.benchmark.Differences;
...
public class Main {
  ...
  public static void generateModelsWithBenji() {
    try {
      BenchmarkFactory.benchmark().metamodel(EcorePackage.eINSTANCE).metamodel(se.mdh.idt.benji.examples.ecore.EcorePackage.eINSTANCE).model("benchmark/input/ecore_1.xmi").difference(0, 1, Differences.moveElement).difference(0, 1, Differences.renameElement).difference(0, 1, Differences.moveRenamedElement).build().generate(Benchmark.ALL, "benchmark/output");
      BenchmarkFactory.benchmark().metamodel(EcorePackage.eINSTANCE).metamodel(se.mdh.idt.benji.examples.ecore.EcorePackage.eINSTANCE).model("benchmark/input/ecore_2.xmi").difference(0, 1, Differences.exchangeLocationOfElements).build().generate(Benchmark.ALL, "benchmark/output");
      BenchmarkFactory.benchmark().metamodel(EcorePackage.eINSTANCE).metamodel(se.mdh.idt.benji.examples.ecore.EcorePackage.eINSTANCE).model("benchmark/input/ecore_3.xmi").difference(0, 1, Differences.updateReferenceTarget).build().generate(Benchmark.ALL, "benchmark/output");
    } catch (Throwable _e) {
  ...
  public static void generateEMFCompareResults() {
    try {
      ...
      EPackage.Registry.INSTANCE.put(se.mdh.idt.benji.examples.ecore.EcorePackage.eNS_URI, 
        se.mdh.idt.benji.examples.ecore.EcorePackage.eINSTANCE);
