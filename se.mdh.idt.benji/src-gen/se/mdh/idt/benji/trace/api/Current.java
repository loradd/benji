...
public final class Current extends BaseGeneratedEMFQuerySpecification<Current.Matcher> {
  ...
  public static abstract class Match extends BasePatternMatch {
     ...
     * 
     */
    public static Current.Match newMutableMatch(final TraceLink pTraceLink, final EObject pTarget) {
     ...
     * 
     */
    public static Current.Match newMatch(final TraceLink pTraceLink, final EObject pTarget) {
  ...
  public static class Matcher extends BaseMatcher<Current.Match> {
     ...
     * 
     */
    public Collection<Current.Match> getAllMatches(final TraceLink pTraceLink, final EObject pTarget) {
     ...
     * 
     */
    public Current.Match getOneArbitraryMatch(final TraceLink pTraceLink, final EObject pTarget) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final TraceLink pTraceLink, final EObject pTarget, final IMatchProcessor<? super Current.Match> processor) {
     ...
     * 
     */
    public Current.Match newMatch(final TraceLink pTraceLink, final EObject pTarget) {
      return Current.Match.newMatch(pTraceLink, pTarget);
    }
     ...
     * 
     */
    public Set<EObject> getAllValuesOftarget(final Current.Match partialMatch) {
    ...
    protected Current.Match tupleToMatch(final Tuple t) {
      try {
          return Current.Match.newMatch((TraceLink) t.get(POSITION_TRACELINK), (EObject) t.get(POSITION_TARGET));
    ...
    protected Current.Match arrayToMatch(final Object[] match) {
      try {
          return Current.Match.newMatch((TraceLink) match[POSITION_TRACELINK], (EObject) match[POSITION_TARGET]);
      } catch(ClassCastException e) {
    ...
    protected Current.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Current.Match.newMutableMatch((TraceLink) match[POSITION_TRACELINK], (EObject) match[POSITION_TARGET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
