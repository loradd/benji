...
import se.mdh.idt.benji.util.EObjectExtensions;
...
public class TraceLinkImpl extends MinimalEObjectImpl.Container implements TraceLink {
	 ...
	 * @ordered
	 */
	protected static final String IDENTIFIER_EDEFAULT = UUID.randomUUID().toString();
	...
	public void setSource(EObject newSource) {
		EObjectExtensions.removeIdentifier(source);
		EObject oldSource = source;
		source = newSource;
		EObjectExtensions.setIdentifier(source, identifier);
		if (eNotificationRequired())
	...
	public void setTarget(EObject newTarget) {
		EObjectExtensions.removeIdentifier(target);
		EObject oldTarget = target;
		target = newTarget;
		EObjectExtensions.setIdentifier(target, identifier);
		if (eNotificationRequired())
