...
public final class Preserved extends BaseGeneratedEMFQuerySpecification<Preserved.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.trace.preserved pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    private Match(final EObject pSource, final EObject pTarget) {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.trace.preserved";
    }
     ...
     * 
     */
    public static Preserved.Match newMutableMatch(final EObject pSource, final EObject pTarget) {
     ...
     * 
     */
    public static Preserved.Match newMatch(final EObject pSource, final EObject pTarget) {
      return new Immutable(pSource, pTarget);
    }
    
    private static final class Mutable extends Preserved.Match {
      Mutable(final EObject pSource, final EObject pTarget) {
    ...
    private static final class Immutable extends Preserved.Match {
      Immutable(final EObject pSource, final EObject pTarget) {
        super(pSource, pTarget);
      }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.trace.preserved pattern,
  ...
  public static class Matcher extends BaseMatcher<Preserved.Match> {
     ...
     * 
     */
    public Collection<Preserved.Match> getAllMatches(final EObject pSource, final EObject pTarget) {
     ...
     * 
     */
    public Preserved.Match getOneArbitraryMatch(final EObject pSource, final EObject pTarget) {
     ...
     * 
     */
    public boolean hasMatch(final EObject pSource, final EObject pTarget) {
     ...
     * 
     */
    public int countMatches(final EObject pSource, final EObject pTarget) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final EObject pSource, final EObject pTarget, final IMatchProcessor<? super Preserved.Match> processor) {
     ...
     * 
     */
    public Preserved.Match newMatch(final EObject pSource, final EObject pTarget) {
      return Preserved.Match.newMatch(pSource, pTarget);
    }
     ...
     * 
     */
    public Set<EObject> getAllValuesOfsource(final Preserved.Match partialMatch) {
     ...
     * 
     */
    public Set<EObject> getAllValuesOfsource(final EObject pTarget) {
     ...
     * 
     */
    public Set<EObject> getAllValuesOftarget(final Preserved.Match partialMatch) {
     ...
     * 
     */
    public Set<EObject> getAllValuesOftarget(final EObject pSource) {
    ...
    protected Preserved.Match tupleToMatch(final Tuple t) {
      try {
          return Preserved.Match.newMatch((EObject) t.get(POSITION_SOURCE), (EObject) t.get(POSITION_TARGET));
    ...
    protected Preserved.Match arrayToMatch(final Object[] match) {
      try {
          return Preserved.Match.newMatch((EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET]);
      } catch(ClassCastException e) {
    ...
    protected Preserved.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Preserved.Match.newMutableMatch((EObject) match[POSITION_SOURCE], (EObject) match[POSITION_TARGET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
  ...
  public Preserved.Match newMatch(final Object... parameters) {
    return Preserved.Match.newMatch((org.eclipse.emf.ecore.EObject) parameters[0], (org.eclipse.emf.ecore.EObject) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.trace.Preserved (visibility: PUBLIC, simpleName: Preserved, identifier: se.mdh.idt.benji.trace.Preserved, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.trace.Preserved (visibility: PUBLIC, simpleName: Preserved, identifier: se.mdh.idt.benji.trace.Preserved, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find source(traceLink, source)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_traceLink, var_source), Source.instance().getInternalQueryRepresentation());
          //  	find target(traceLink, target)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_traceLink, var_target), Target.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
