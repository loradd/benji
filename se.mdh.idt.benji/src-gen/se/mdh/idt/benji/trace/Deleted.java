...
public final class Deleted extends BaseGeneratedEMFQuerySpecification<Deleted.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.trace.deleted pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.trace.deleted";
    }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.trace.deleted pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.trace.Deleted (visibility: PUBLIC, simpleName: Deleted, identifier: se.mdh.idt.benji.trace.Deleted, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.trace.Deleted (visibility: PUBLIC, simpleName: Deleted, identifier: se.mdh.idt.benji.trace.Deleted, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //  	neg find target(traceLink, _)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_traceLink, var___0_), Target.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
