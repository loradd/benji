...
public final class Created extends BaseGeneratedEMFQuerySpecification<Created.Matcher> {
  /**
   * Pattern-specific match representation of the se.mdh.idt.benji.trace.created pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "se.mdh.idt.benji.trace.created";
    }
  ...
  /**
   * Generated pattern matcher API of the se.mdh.idt.benji.trace.created pattern,
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: se.mdh.idt.benji.trace.Created (visibility: PUBLIC, simpleName: Created, identifier: se.mdh.idt.benji.trace.Created, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: se.mdh.idt.benji.trace.Created (visibility: PUBLIC, simpleName: Created, identifier: se.mdh.idt.benji.trace.Created, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: se.mdh.idt.benji.trace) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public Set<PBody> doGetContainedBodies() {
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	neg find source(traceLink, _)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_traceLink, var___0_), Source.instance().getInternalQueryRepresentation());
          //  	find target(traceLink, target)
