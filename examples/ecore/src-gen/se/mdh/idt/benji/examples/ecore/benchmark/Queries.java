...
import se.mdh.idt.benji.examples.ecore.benchmark.ExchangeLocationOfElementsPostcondition;
import se.mdh.idt.benji.examples.ecore.benchmark.ExchangeLocationOfElementsPrecondition;
import se.mdh.idt.benji.examples.ecore.benchmark.MoveElementPostcondition;
import se.mdh.idt.benji.examples.ecore.benchmark.MoveElementPrecondition;
import se.mdh.idt.benji.examples.ecore.benchmark.MoveRenamedElementPostcondition;
import se.mdh.idt.benji.examples.ecore.benchmark.MoveRenamedElementPrecondition;
import se.mdh.idt.benji.examples.ecore.benchmark.RenameElementPostcondition;
import se.mdh.idt.benji.examples.ecore.benchmark.RenameElementPrecondition;
import se.mdh.idt.benji.examples.ecore.benchmark.UpdateReferenceTargetPostcondition;
import se.mdh.idt.benji.examples.ecore.benchmark.UpdateReferenceTargetPrecondition;
 ...
 * 
 * <p> From package se.mdh.idt.benji.examples.ecore.benchmark, the group contains the definition of the following patterns: <ul>
