...
public class Bpmn2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Bpmn2Package.PROCESS: {
				se.mdh.idt.benji.examples.bpmn2.Process process = (se.mdh.idt.benji.examples.bpmn2.Process)theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(se.mdh.idt.benji.examples.bpmn2.Process object) {
		return null;
	}
